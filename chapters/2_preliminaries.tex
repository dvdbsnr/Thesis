...
in Chapter~\ref{C: surplus edges} and of Theorems~\ref{T: folk theorem} and \eqref{T: Main} in Chapter~\ref{C: convergence}.
...
\begin{definition}[Modulus of continuity, {\cite[p.122]{Billingsley.1999}}] \label{D: modulus of continuity}
	...
	\begin{equation*}
		w_x([a,b]) := \sup_{s,t \in I[a,b]}|x(s)  -x(t)|.
	\end{equation*}
\end{definition}
...
\begin{theorem}[Central limit theorem for martingales] \label{T: functional CLT martingales}
	...
	Then $M_n \longrightarrow_d X$ where $X$ is a process with sample paths in $C[0,\infty)$ and independent Gaussian increments.
\end{theorem}
