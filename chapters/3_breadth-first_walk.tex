...
\begin{figure}[H]
	...
	{\input{figures/fig_bf_walk_discrete.tex}}
...
\begin{figure}[H]
	...
	{\input{figures/fig_component.tex}}\\
	
	\centering
	\subfloat[The continuous-time breadth-first walk]
	{\input{figures/fig_bf_walk_cont.tex}}
...
\begin{corollary}
	...
	Moreover, $\Zn$ and $\Mn$ are \cadlaq{} processes of bounded variation.
\end{corollary}
...
\begin{proof}
	...
	By the Jordan Decomposition, $\Zn$ is of bounded variation and the jumps make it a \cadlaq{} process.
	Since $\Mn = \Zn - \An$ is the difference of two functions of bounded variation is again of bounded variation.
	Since $\An$ is continuous and $\Zn$ is \cadlaq{}, $\Mn$ is \cadlaq{}.
\end{proof}
...
\fxnote{Fix references to CLT Theorem}
we need to make sure that our processes satisfy conditions \eqref{E: CLT cond 1} to \eqref{E: CLT cond 3}.
\fxnote{Fix references to CLT eqs}
\fxnote{Maybe rescale the processes here?}
