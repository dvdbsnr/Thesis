...
then show that there can not be any more excursion of $f_n$ of sufficient length.
	...
	% \Xi(C) \subseteq \Xin(C)
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\subsubsection*{$\Xi(C) \subseteq \Xin(C)$:}
	This is the proof of the first part. 
	It goes on for a bit and then it's done and it stops.
	How nice. Wow.
	\lipsum[100]
	...
	% \Xin(C) \subseteq \Xi(C)
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\item[$\Xin(C) \subseteq \Xi(C)$:]
	This is the proof of the second thing.
	Again, this drags on for a bit,
