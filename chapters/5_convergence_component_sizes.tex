...
\begin{proof}
	...
	\begin{aligned}
	\Prob(\ExcursionEvent) 
	&\leq \ExpBig{ \text{Number of excursions $\gamma: \; |\gamma| \geq \delta\n{2}{3},l(\gamma) \geq C\n{2}{3}$ } } \\
	&= \ExpBig{ \sum_{\gamma: \; l(\gamma) \geq C\n{2}{3}} \Ind{\{|\gamma| \geq \delta\n{2}{3} \} } } \\
	&\leq \ExpBig{ \sum_{\gamma: \; l(\gamma) \geq C\n{2}{3}} \frac{|\gamma|^2}{\delta^2\n{4}{3}} } \\
	&= \frac{1}{\delta^2\n{4}{3}} \ExpBig{ \sum_{\gamma: \; l(\gamma) \geq C\n{2}{3}}  |\gamma|^2 }.
	\end{aligned}
	\end{equation}
	...
	\begin{aligned}
	\Prob(\ExcursionEvent) 
	&\leq \frac{1}{\delta^2\n{4}{3}} \ExpBig{ \sum_{\Ccal \in \Gcal(n-T, \p)}  |\Ccal|^2  } \\
	&\leq \frac{1}{\delta^2\n{4}{3}} \ExpBig{ \sum_{\Ccal \in \Gcal(n-C\n{2}{3}, \p)}  |\Ccal|^2  } \\
	&\leq \frac{1}{\delta^2\n{4}{3}} \ExpBig{ \sum_{\Ccal \in \Gcal(n-C\n{2}{3}, \p)}  |\Ccal|^2 }.
	\end{aligned}
	\end{equation}
	...
	\begin{aligned}
	\ExpBig{\sum_{\Ccal \in \Gcal(k, \p)} |\Ccal|^2 } 
	&= \ExpBig{ \sum_{\Ccal \in \Gcal(k, \p)} |\Ccal| \sum_{v \in \Ccal} 1} \\
	&= \ExpBig{ \sum_{\Ccal \in \Gcal(k, \p)} |\Ccal| \sum_{v \in \Gcal(k, \p)} \Ind{\{v \in \Ccal\}} } \\
	&= \sum_{v \in \Gcal(k, \p)} \ExpBig{ \sum_{\Ccal \in \Gcal(k, \p)} |\Ccal| \Ind{\{v \in \Ccal\}} } \\ 
	&= \sum_{v \in \Gcal(k, \p)} \ExpBig{|\Ccal(v)|} \\
	&= k \ExpBig{|\Ccal(1)|},
	\end{aligned}
	\end{equation}
	...
	\begin{equation} \label{E: Exp C(1) <= sum Z}
		\ExpBig{|\Ccal(1)|} \leq \sum_{j=0}^{\infty}\ExpBig{Z_j}.
	\end{equation}	
...
\begin{lemma} \label{L: BM in ld}
	...
	Then
	\begin{equation}
		\ExpBig{\sum_{\gamma \in \Gamma^{\pp}} |\gamma|^2} < \infty.
	\end{equation}
\end{lemma}
...
\begin{equation} \label{E: gamma delta epsilon}
	\ExpBig{\sum_{|\gamma| < \delta} |\gamma|^2} < \epsilon.
\end{equation}
...
\begin{lemma} \label{L: sum rgamman}
	...
	\begin{equation}
		\sup_n \ExpBig{\sum_{|\rgamman| < \delta} |\rgamman|^2} < \epsilon.
	\end{equation}
\end{lemma}
\begin{proof}
	We have
	\begin{equation}
		\ExpBig{\sum_{|\rgamman| < \delta} |\rgamman|^2} 
		= \ExpBig{\sum_{l(\rgamman) > C} |\rgamman|^2} 
		+ \ExpBig{\sum_{\substack{l(\rgamman) \leq C \\ |\rgamman| < \delta}} |\rgamman|^2}.
	\end{equation}
	Consider the second term:
	\begin{equation}
		\ExpBig{\sum_{\substack{l(\rgamman) \leq C \\ |\rgamman| < \delta}} |\rgamman|^2}
		= \ExpBig{\sum_{k = 0}^{\infty} \sum_{\substack{l(\rgamman) \leq C \\ |\rgamman| \in I_{\delta, k}}} |\rgamman|^2}
	\end{equation}
	...
	\begin{equation}
		\ExpBig{ \sum_{l(\rgamman) > C} |\rgamman|^2 } < \epsilon / 2.
	\end{equation}
	For this $C$ choose $\delta > 0$ such that $4C\delta < \epsilon/2$.
	Then
	\begin{equation}
		\ExpBig{\sum_{|\rgamman| < \delta} |\rgamman|^2}  < \epsilon.
	\end{equation}
