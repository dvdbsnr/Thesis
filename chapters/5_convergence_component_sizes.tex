...
\section{Analysis of late excursions}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Theorem~\ref{T: Main} requires additional information about Brownian motion.
...
\begin{proof}[Proof of Folk Theorem~\ref{T: folk theorem}]
	...
	and that the $k$-th excursion of $\WtX$ is large.
