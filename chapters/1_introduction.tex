...
like \emph{preferential attachment} or some other model.
...
which the component sizes of the Erdös-Renyi random graph pass through,
...
\begin{figure}[h]
	...
	\caption{Realizations of the Erdös-Renyi random graph on $n=1000$ vertices with different $\lambda = n \pp$.}%
	\label{F: ER}%
\end{figure}
...
\begin{figure}[h]
	...
	\quad
	\subfloat[$\pp = 0$]{\includegraphics[page=1,width=.31\textwidth]{figures/chapter1/ER_1000_0}}%
	\quad
