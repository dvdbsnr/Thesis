...
\begin{figure}[h]
	...
	\caption{Realizations of the Erdös-Rényi random graph on $n=1000$ vertices with varying $\lambda = n \p$.}%
	\label{F: ER lambda}%
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Realizations of the Erdös-Rényi random graph on $n=1000$ vertices with varying $\pp$.}%
	\label{F: ER p}%
\end{figure}
...
Denote by $W$ the standard Brownian motion on $\Rplus$. 
