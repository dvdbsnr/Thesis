...
\begin{proof} \label{P: formula an}
	...
	\begin{equation}
	P(\text{A new edge appears in $[s, s+ds]$} \cond \SigmaAlgebra_s^k) 
	...
	\begin{aligned}
	P(\text{A new edge appears in $[s, s+ds]$} \cond \SigmaAlgebra_s)
	&= \Exp{\text{A new edge appears in $[s, s+ds]$} \cond \SigmaAlgebra_s} \\
	&= \Exp{ \Exp{\text{A new edge appears in $[s, s+ds]$} \cond \SigmaAlgebra_s^k} \cond \SigmaAlgebra_s} \\
